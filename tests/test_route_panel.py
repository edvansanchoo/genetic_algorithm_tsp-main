...
def _trip(*node_quantities: tuple[str, int]) -> Trip:
    stops = [
...
class RoutePanelTests(unittest.TestCase):
    def test_format_trip_starts_and_ends_with_d(self):
        ...
        self.assertTrue(line.startswith("Viagem 1: DEPOT \u2192"))
        self.assertIn("\u2192 DEPOT  (9/10)", line)
    ...
    def test_format_vehicle_section(self):
        ...
        self.assertIn("DEPOT \u2192 A \u2192 DEPOT", lines[1])
        self.assertIn("DEPOT \u2192 B \u2192 DEPOT", lines[2])
